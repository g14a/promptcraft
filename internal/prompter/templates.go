...
const (
	...
	structuredOutputHint = "Structure your response with clear, labeled sections. For JSON/schema requirements, " +
		"consider using Claude API structured outputs (output_config.format) to guarantee valid formatting."
	structuredOutputAPIHint = "Consider using Claude API structured outputs (output_config.format) " +
...
const (
	...
	roleCodeBuild = "Expert software engineer. Design and implement correct, idiomatic, " +
		"production-quality code from scratch."
	roleCodeModify    = "Expert software engineer. Diagnose and fix issues precisely with minimal, targeted changes."
	roleCodeArchitect = "Expert software architect. Design scalable systems and guide implementation " +
	...
	// Specialized roles.
	roleDebugSpecialist = "Expert debugging specialist. Systematically identify root causes " +
		"and implement targeted fixes."
	rolePerformanceExpert = "Performance optimization expert. Profile bottlenecks " +
	...
	roleScrapingSpecialist  = "Web scraping specialist. Build ethical, robust scrapers " +
	...
	roleDistributedSystems = "Distributed systems architect. Design resilient microservices " +
		"and container orchestration."
	roleFintechEngineer = "Financial technology engineer. Build compliant fintech solutions " +
		"with proper risk management."
	roleHealthcareEngineer = "Healthcare software engineer. Develop HIPAA-compliant medical applications " +
		"with data privacy."
...
const (
	outputFormatCodeBuild = "State any assumptions and external dependencies first. " +
		"Explain key design decisions briefly, then provide the complete, working implementation. " +
		"After the code, confirm it satisfies all stated requirements."
	outputFormatCodeBuildMulti = "Break down the implementation into numbered steps. " + outputFormatCodeBuild
	outputFormatCodeModify     = "State the root cause and your reasoning. Show the complete, corrected code. " +
	...
	outputFormatAnalysisQuestion = "Answer directly and concisely. Support each key point with specific examples. " +
		"Flag any uncertain claims explicitly."
	outputFormatAnalysisGeneral = "Use structured prose with evidence for each point. " +
		"Include a brief summary at the end. Note any areas where information is limited or confidence is low."
...
const (
	...
	constraintModifyInterfaces = "Preserve existing function signatures and public interfaces " +
		"unless modification is required"
	...
	constraintAnalysisUncertainty = "Flag any claims as uncertain when supporting evidence is " +
		"limited or unavailable"
	constraintAnalysisLimitations = "Acknowledge relevant trade-offs, caveats, or limitations " +
		"where they apply to your analysis"
	...
	constraintCloudPlatform = "Include error handling for cloud service limits, authentication, " +
		"and region considerations"
)
